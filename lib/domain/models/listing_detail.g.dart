...
_ListingDetail _$ListingDetailFromJson(
  ...
  texturedGlbUrl: json['textured_glb_url'] as String?,
  photogrammetryStatus: json['photogrammetry_status'] as String?,
...
Map<String, dynamic> _$ListingDetailToJson(
  _ListingDetail instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'textured_glb_url': instance.texturedGlbUrl,
  'photogrammetry_status': instance.photogrammetryStatus,
...
_AreaPriceStats _$AreaPriceStatsFromJson(Map<String, dynamic> json) =>
    _AreaPriceStats(
      subwayStation: json['subway_station'] == null
          ? null
...
Map<String, dynamic> _$AreaPriceStatsToJson(_AreaPriceStats instance) =>
    <String, dynamic>{
      'subway_station': instance.subwayStation,
      'location': instance.location,
    };

_AreaPriceBenchmark _$AreaPriceBenchmarkFromJson(Map<String, dynamic> json) =>
    _AreaPriceBenchmark(
...
Map<String, dynamic> _$AreaPriceBenchmarkToJson(_AreaPriceBenchmark instance) =>
    <String, dynamic>{
      'mean': instance.mean,

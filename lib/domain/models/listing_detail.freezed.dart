...
as double?,roomScanFurnitureEdits: freezed == roomScanFurnitureEdits ? _self.roomScanFurnitureEdits : roomScanFurnitureEdits // ignore: cast_nullable_to_non_nullable
...
/// stored server-side verbatim and passed back into the viewer on open.
 final  Map<String, dynamic>? _roomScanFurnitureEdits;
/// Cumulative furniture edits from the iOS 3D viewer (schema v1 document),
/// stored server-side verbatim and passed back into the viewer on open.
@override@JsonKey(name: "room_scan_furniture_edits") Map<String, dynamic>? get roomScanFurnitureEdits {
  final value = _roomScanFurnitureEdits;
  if (value == null) return null;
  if (_roomScanFurnitureEdits is EqualUnmodifiableMapView) return _roomScanFurnitureEdits;
...
as double?,roomScanWorldPlusXBearingDeg: freezed == roomScanWorldPlusXBearingDeg ? _self.roomScanWorldPlusXBearingDeg : roomScanWorldPlusXBearingDeg // ignore: cast_nullable_to_non_nullable
as double?,roomScanNorthCorrectionDeg: freezed == roomScanNorthCorrectionDeg ? _self.roomScanNorthCorrectionDeg : roomScanNorthCorrectionDeg // ignore: cast_nullable_to_non_nullable
as double?,roomScanFurnitureEdits: freezed == roomScanFurnitureEdits ? _self._roomScanFurnitureEdits : roomScanFurnitureEdits // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,contactPhone: freezed == contactPhone ? _self.contactPhone : contactPhone // ignore: cast_nullable_to_non_nullable
as String?,contactTelegram: freezed == contactTelegram ? _self.contactTelegram : contactTelegram // ignore: cast_nullable_to_non_nullable
as String?,addressLatitude: freezed == addressLatitude ? _self.addressLatitude : addressLatitude // ignore: cast_nullable_to_non_nullable
as double?,addressLongitude: freezed == addressLongitude ? _self.addressLongitude : addressLongitude // ignore: cast_nullable_to_non_nullable

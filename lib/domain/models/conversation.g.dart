...
_$ConversationSummaryImpl _$$ConversationSummaryImplFromJson(
  ...
  listingMinPrice: (json['listing_min_price'] as num?)?.toInt(),
  listingMaxPrice: (json['listing_max_price'] as num?)?.toInt(),
...
Map<String, dynamic> _$$ConversationSummaryImplToJson(
  ...
  'listing_min_price': instance.listingMinPrice,
  'listing_max_price': instance.listingMaxPrice,

...
Future<void> configureDependencies() async {
  ...
  getIt.registerLazySingleton<IListingGroupService>(
    () => ListingGroupService(getIt<IOAuthApiClient>()),
  );
  ...
  getIt.registerLazySingleton<IAdminModerationUserPickerService>(
    () => AdminModerationUserPickerService(getIt<IOAuthApiClient>()),
  );
  ...
  getIt.registerLazySingleton<IAdminTelegramMiniAppLocationService>(
    () => AdminTelegramMiniAppLocationService(getIt<IOAuthApiClient>()),
  );
  ...
  getIt.registerLazySingleton<IGigModerationAdminService>(
    () => GigModerationAdminService(getIt<IOAuthApiClient>()),
  );

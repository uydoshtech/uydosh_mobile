...
/// iOS: download USDZ then present system Quick Look (fixes unreliable third-party plugin).
class UsdzQuickLookService {
  UsdzQuickLookService._();

  static const MethodChannel _channel = MethodChannel("uydosh/usdz_quick_look");

  /// Returns true if Quick Look was presented.

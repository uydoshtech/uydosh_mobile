...
class AppStrings {
  static final Map<String, Map<String, String>> _strings = {
    "en": {
      ...
      "admin_panel_section_reassign_ownership": "Reassign ownership",
      "admin_reassign_ownership_title": "Reassign ownership",
      "admin_reassign_ownership_intro":
      ...
      "admin_reassign_ownership_entity_type_label": "Entity type",
      "admin_reassign_ownership_type_listing": "Listing",
      "admin_reassign_ownership_type_gig_offer": "Gig service (offer)",
      "admin_reassign_ownership_type_gig_request": "Gig task (request)",
      "admin_reassign_ownership_entity_id_label": "Entity id",
      "admin_reassign_ownership_from_user_label": "Current owner user id (optional)",
      "admin_reassign_ownership_from_user_hint":
          "If set, must match the current owner or the request fails (e.g. 86).",
      "admin_reassign_ownership_to_user_label": "New owner user id",
    ...
    "ru": {
      ...
      "admin_panel_section_reassign_ownership": "Смена владельца",
      "admin_reassign_ownership_title": "Смена владельца",
      "admin_reassign_ownership_intro":
      ...
      "admin_reassign_ownership_entity_type_label": "Тип сущности",
      "admin_reassign_ownership_type_listing": "Объявление",
      "admin_reassign_ownership_type_gig_offer": "Услуга (оффер)",
      "admin_reassign_ownership_type_gig_request": "Задача (запрос)",
      "admin_reassign_ownership_entity_id_label": "Id сущности",
      "admin_reassign_ownership_from_user_label":
          "Текущий владелец (id), необязательно",
      "admin_reassign_ownership_from_user_hint":
          "Если указано, должно совпадать с текущим владельцем (например, 86).",
      "admin_reassign_ownership_to_user_label": "Новый владелец (id пользователя)",
    ...
    "uz": {
      ...
      "admin_panel_section_reassign_ownership": "Egaga o'tkazish",
      "admin_reassign_ownership_title": "Egaga o'tkazish",
      "admin_reassign_ownership_intro":
      ...
      "admin_reassign_ownership_entity_type_label": "Ob'ekt turi",
      "admin_reassign_ownership_type_listing": "E'lon",
      "admin_reassign_ownership_type_gig_offer": "Xizmat (offer)",
      "admin_reassign_ownership_type_gig_request": "Vazifa (request)",
      "admin_reassign_ownership_entity_id_label": "Ob'ekt id",
      "admin_reassign_ownership_from_user_label":
          "Joriy egasi foydalanuvchi id (ixtiyoriy)",
      "admin_reassign_ownership_from_user_hint":
          "Ko'rsatilsa, joriy egasi bilan mos kelishi kerak (masalan, 86).",
      "admin_reassign_ownership_to_user_label": "Yangi egasi foydalanuvchi id",

...
class AppStrings {
  static final Map<String, Map<String, String>> _strings = {
    "en": {
      ...
      "gigs_post_request_field_amount": "Amount (UZS)",
      ...
      "gigs_post_offer_field_price": "Price (UZS)",
    ...
    "ru": {
      ...
      "gigs_post_request_field_amount": "Сумма (UZS)",
      ...
      "gigs_post_offer_field_price": "Цена (UZS)",
    ...
    "uz": {
      ...
      "gigs_post_request_field_amount": "Summa (UZS)",
      ...
      "gigs_post_offer_field_price": "Narx (UZS)",

...
class AppStrings {
  static final Map<String, Map<String, String>> _strings = {
    "en": {
      ...
      "group_size_target_option": "{count} people total",
      "group_budget_per_person_label": "Budget per person (y.e./mo)",
    ...
    "ru": {
      ...
      "group_size_target_option": "{count} человек всего",
      "group_budget_per_person_label": "Бюджет на человека (y.e./мес)",
    ...
    "uz": {
      ...
      "group_size_target_option": "Jami {count} kishi",
      "group_budget_per_person_label": "Har bir kishi uchun byudjet (y.e./oy)",

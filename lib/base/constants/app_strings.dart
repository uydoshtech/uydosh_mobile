...
class AppStrings {
  static final Map<String, Map<String, String>> _strings = {
    "en": {
      ...
      "title_group_forming": "#FormingGroup",
      ...
      "listing_type_short_group_forming": "#FormingGroup",
    ...
    "ru": {
      ...
      "title_group_forming": "#СобираемГруппу",
      ...
      "listing_type_short_group_forming": "#СобираемГруппу",
    ...
    "uz": {
      ...
      "title_group_forming": "#GuruhYigamiz",
      ...
      "listing_type_short_group_forming": "#GuruhYigamiz",

...
class AppStrings {
  static final Map<String, Map<String, String>> _strings = {
    "en": {
      ...
      "admin_reassign_owner_from_user": "Current owner user id: {id}",
      "admin_reassign_owner_entity_label": "Entity: {entity} · id {id}",
    ...
    "ru": {
      ...
      "admin_reassign_owner_from_user": "Текущий владелец (id): {id}",
      "admin_reassign_owner_entity_label": "Сущность: {entity} · id {id}",
    ...
    "uz": {
      ...
      "admin_reassign_owner_from_user": "Joriy egasi foydalanuvchi id: {id}",
      "admin_reassign_owner_entity_label": "Ob'ekt: {entity} · id {id}",

...
class AppStrings {
  static final Map<String, Map<String, String>> _strings = {
    "en": {
      ...
      "create_choice_roommate_needed": "I have a room",
      ...
      "map_update_my_location": "Update my location",
      "map_pin_approximate_location": "Approximate location",
      "close": "Close",
      "cancel": "Cancel",
      "done": "Done",
      ...
      "host_resident": "I live here",
      "host_resident_no": "Does not live on site",
      "with_photo": "With photo",
      "search_filter_private_room": "Own room",
      "search_filter_with_photo": "Photos",
      "search_filter_3d_view": "3D View",
      ...
      "room_3d_mode_full_room": "Full room",
      "room_3d_mode_floor_and_furniture": "Floor and furniture",
      "room_3d_mode_floor_only": "Floor only",
      ...
      "settings_section_map": "Map settings",
      ...
      "my_hub_tab_bookmarks": "Housing options",
      ...
      "admin_app_setting_web_multi_instance_check_title":
          "Lock duplicate sessions (web + Telegram)",
      "admin_app_setting_web_multi_instance_check_subtitle":
          "When on, opening UyDosh in a new browser tab locks older tabs, and opening the Telegram Mini App elsewhere ends older Telegram sessions. Has no effect on the native iOS/Android apps.",
      ...
      "admin_listing_duplicate_badge": "Possible duplicate #{id}",
      "admin_listing_duplicate_badge_high": "Likely duplicate #{id}",
      "admin_listing_duplicate_approve_title": "Approve possible duplicate?",
      "admin_listing_duplicate_approve_message":
          "Looks like a repost of listing #{id} ({fields}). Approve anyway?",
      "admin_listing_duplicate_field_listing_type_id": "type",
      "admin_listing_duplicate_field_subway_station_id": "metro",
      "admin_listing_duplicate_field_location_id": "district",
      "admin_listing_duplicate_field_price": "price",
      "admin_listing_duplicate_field_rooms_number": "rooms",
      "admin_listing_duplicate_field_private_room": "private room",
      "admin_listing_duplicate_field_gender": "gender",
      "admin_listing_duplicate_field_title": "title",
      "admin_parser_review_duplicate_banner":
          "Possible duplicate of listing #{id} ({fields})",
      ...
      "admin_parser_review_owner_section": "Contact telegram",
    ...
    "ru": {
      ...
      "create_choice_roommate_needed": "Есть комната",
      "create_choice_roommate_needed_subtitle":
      ...
      "map_update_my_location": "Обновить мою геопозицию",
      "map_pin_approximate_location": "Примерное местоположение",
      "close": "Закрыть",
      "cancel": "Отмена",
      "done": "Готово",
      ...
      "host_resident": "Проживаю здесь",
      "host_resident_no": "Не проживает на объекте",
      "with_photo": "С фото",
      "search_filter_private_room": "Отдельная комната",
      "search_filter_with_photo": "С фото",
      "search_filter_3d_view": "3D-вид",
      ...
      "room_3d_mode_full_room": "Вся комната",
      "room_3d_mode_floor_and_furniture": "Пол и мебель",
      "room_3d_mode_floor_only": "Только пол",
      ...
      "room_3d_floor_plan_rotate_furniture_message":
          "Ползунок поворачивает; стрелки двигают по полу; поднять/опустить — высота (10 см).",
      ...
      "room_3d_floor_plan_move_furniture_up": "Сдвинуть вверх",
      "room_3d_floor_plan_move_furniture_down": "Сдвинуть вниз",
      "room_3d_floor_plan_move_furniture_left": "Сдвинуть влево",
      "room_3d_floor_plan_move_furniture_right": "Сдвинуть вправо",
      ...
      "settings_section_map": "Настройки карты",
      ...
      "my_hub_tab_bookmarks": "Варианты жилья",
      ...
      "admin_app_setting_web_multi_instance_check_title":
          "Блокировать повторные сессии (веб + Telegram)",
      "admin_app_setting_web_multi_instance_check_subtitle":
          "Если включено, открытие UyDosh в новой вкладке блокирует старые вкладки браузера, а открытие мини-приложения Telegram в другом месте завершает старые сессии Telegram. Не влияет на нативные приложения iOS/Android.",
      ...
      "admin_listing_duplicate_badge": "Возможный дубликат #{id}",
      "admin_listing_duplicate_badge_high": "Похоже на дубликат #{id}",
      "admin_listing_duplicate_approve_title": "Одобрить возможный дубликат?",
      "admin_listing_duplicate_approve_message":
          "Похоже на повтор публикации объявления #{id} ({fields}). Всё равно одобрить?",
      "admin_listing_duplicate_field_listing_type_id": "тип",
      "admin_listing_duplicate_field_subway_station_id": "метро",
      "admin_listing_duplicate_field_location_id": "район",
      "admin_listing_duplicate_field_price": "цена",
      "admin_listing_duplicate_field_rooms_number": "комнаты",
      "admin_listing_duplicate_field_private_room": "отдельная комната",
      "admin_listing_duplicate_field_gender": "пол",
      "admin_listing_duplicate_field_title": "заголовок",
      "admin_parser_review_duplicate_banner":
          "Возможный дубликат объявления #{id} ({fields})",
      ...
      "admin_parser_review_owner_section": "Контакт в Telegram",
      "admin_parser_review_owner_hint": "username",
      "admin_parser_review_owner_help":
    ...
    "uz": {
      ...
      "create_choice_roommate_needed": "Xonam bor",
      "create_choice_roommate_needed_subtitle":
      ...
      "map_update_my_location": "Joylashuvimni yangilash",
      "map_pin_approximate_location": "Taxminiy joylashuv",
      "close": "Yopish",
      "cancel": "Bekor qilish",
      "done": "Tayyor",
      ...
      "host_resident": "Bu yerda yashayman",
      "host_resident_no": "Bu yerda yashamaydi",
      "with_photo": "Surat bilan",
      "search_filter_private_room": "Shaxsiy xona",
      "search_filter_with_photo": "Suratli",
      "search_filter_3d_view": "3D ko'rinish",
      ...
      "room_3d_mode_full_room": "Butun xona",
      "room_3d_mode_floor_and_furniture": "Pol va mebel",
      "room_3d_mode_floor_only": "Faqat pol",
      ...
      "room_3d_floor_plan_rotate_furniture_message":
          "Slayder buradi; strelkalar pol bo'ylab suradi; ko'tarish/tushirish — balandlik (10 sm).",
      ...
      "room_3d_floor_plan_move_furniture_up": "Yuqoriga surish",
      "room_3d_floor_plan_move_furniture_down": "Pastga surish",
      "room_3d_floor_plan_move_furniture_left": "Chapga surish",
      "room_3d_floor_plan_move_furniture_right": "O'ngga surish",
      ...
      "settings_section_map": "Xarita sozlamalari",
      ...
      "admin_app_setting_web_multi_instance_check_title":
          "Takroriy sessiyalarni bloklash (veb + Telegram)",
      "admin_app_setting_web_multi_instance_check_subtitle":
          "Yoniq bo'lsa, UyDosh yangi brauzer varaqida ochilganda shu brauzerning eski varaqlari bloklanadi, Telegram mini-ilovasi boshqa joyda ochilganda esa eski Telegram sessiyalari tugatiladi. Native iOS/Android ilovalariga ta'sir qilmaydi.",
      ...
      "admin_listing_duplicate_badge": "Ehtimoliy dublikat #{id}",
      "admin_listing_duplicate_badge_high": "Dublikatga o'xshaydi #{id}",
      "admin_listing_duplicate_approve_title": "Dublikatni tasdiqlash?",
      "admin_listing_duplicate_approve_message":
          "Bu #{id} e'lonining qayta joylashiga o'xshaydi ({fields}). Baribir tasdiqlansinmi?",
      "admin_listing_duplicate_field_listing_type_id": "tur",
      "admin_listing_duplicate_field_subway_station_id": "metro",
      "admin_listing_duplicate_field_location_id": "tuman",
      "admin_listing_duplicate_field_price": "narx",
      "admin_listing_duplicate_field_rooms_number": "xonalar",
      "admin_listing_duplicate_field_private_room": "alohida xona",
      "admin_listing_duplicate_field_gender": "jins",
      "admin_listing_duplicate_field_title": "sarlavha",
      "admin_parser_review_duplicate_banner":
          "#{id} e'lonining ehtimoliy dublikati ({fields})",
      ...
      "admin_parser_review_owner_section": "Telegram aloqasi",
      "admin_parser_review_owner_hint": "username",
      "admin_parser_review_owner_help":

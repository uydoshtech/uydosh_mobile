...
class AppStrings {
  static final Map<String, Map<String, String>> _strings = {
    ...
    "ru": {
      ...
      // Preference options
      "non_smoker": "Не курит",
      "occasional_smoker": "Курит иногда",
      "regular_smoker": "Курит регулярно",
      "non_drinker": "Не пьет",
      "occasional_drinker": "Пьет иногда",
      "regular_drinker": "Пьет регулярно",
      "morning": "Утро",
      "evening": "Вечер",
      "night": "Ночь",
      ...
      "very_introverted": "Очень интроверт",
      "introverted": "Интроверт",
      "balanced": "Сбалансированный",
      "extroverted": "Экстраверт",
      "very_extroverted": "Очень экстраверт",
      "yes": "Да",
      "no": "Нет",
    ...
    "uz": {
      ...
      "urgent": "Shoshilinch",
      "any_date": "Har qanday ko'chish sanasi",

...
class AppStrings {
  static final Map<String, Map<String, String>> _strings = {
    "en": {
      ...
      "room_3d_floor_plan_rotate_furniture_title": "Rotate furniture",
      "room_3d_floor_plan_rotate_furniture_message":
          "Drag the slider to rotate the selected item. Range ±180°.",
      "room_3d_floor_plan_rotate_furniture_updated": "Furniture rotated",
    ...
    "ru": {
      ...
      "room_3d_floor_plan_adjust_north_degrees_format": "%+.0f°",
      "room_3d_floor_plan_rotate_furniture_title": "Повернуть мебель",
      "room_3d_floor_plan_rotate_furniture_message":
          "Передвигайте ползунок, чтобы повернуть выбранный предмет. Диапазон ±180°.",
      "room_3d_floor_plan_rotate_furniture_updated": "Мебель повёрнута",
      "room_3d_floor_plan_rotate_furniture_degrees_format": "%+.0f°",
    ...
    "uz": {
      ...
      "room_3d_floor_plan_adjust_north_degrees_format": "%+.0f°",
      "room_3d_floor_plan_rotate_furniture_title": "Mebelni burish",
      "room_3d_floor_plan_rotate_furniture_message":
          "Tanlangan buyumni burish uchun slayderni suring. Oraliq ±180°.",
      "room_3d_floor_plan_rotate_furniture_updated": "Mebel burildi",
      "room_3d_floor_plan_rotate_furniture_degrees_format": "%+.0f°",

...
class ProfileStatsSection extends StatelessWidget {
  ...
  final String Function(UserProfileUniversity university) getLocalizedUniversityName;
                      ...
                      children: [
                        if (((profile.name ?? cachedGoogleDisplayName) ?? "")
                          ...
                          _buildProfileFieldRow(
                            ...
                            icon: Icons.person,
                            label: L10n.get("name"),
                            value: profile.name ?? cachedGoogleDisplayName ?? "",
                          ),
                        ...
                        if (profile.university != null) ...[
                          _buildProfileFieldRow(
                            ...
                            value: getLocalizedUniversityName(profile.university!),
                          ),
                          const SizedBox(height: 24),
                        ],
                        _buildProfileFieldRow(
  ...
  Widget _buildTelegramField(BuildContext context) {
    final hasTelegram = profile.telegram != null &&
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    hasTelegram ? "@${profile.telegram!}" : L10n.get("not_specified"),
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                    ),

...
import "package:uy_dosh/presentation/screens/auth/auth_wizard_pages/auth_wizard_profile_offer_page.dart";
...
class _AuthWizardScreenState extends State<AuthWizardScreen> {
  ...
  int? _selectedGender;
  bool? _isStudent;
  String? _selectedRole; // tenant | landlord
  ...
  void initState() {
    ...
    // Load regions when screen initializes. Uzbekistan is the fixed default
    // country, so only city selection is exposed in the UI.
    _loadRegions();
